...
<tr>
   ...
   <p align="center">Borsa Islem Defteri Overall Üstü Raporu<font color="#FFFF00"><b><br>
   (Ana makineyi yoran bir rapordur; akşam almaya dikkat ediniz)</b></font></td>
</tr>
<tr>
    <td colspan="2" nowrap>
...
<%= SubeSatiriYaz%>
  ...
  <tr>
    ...
    <tr>
      ...
      <tr>
         <td>Overall Aşım Katı</td>
         <td><input type="text" class="numeric" maxlength="12" floatlen="8" size="12" name="OVERALL_ASIM_KATI" value="5"></td>
      </tr>
<!-- #include file="printdest.inc" -->
	  ...
	  <tr>
	   <td class="header" nowrap><p align="center">Bu Raporu Sadece Excel ve Ekrana Alabilirsiniz.<font color="#FFFF00"><b><br>
	  </tr>
  </table>
  </center>
</div>
...
<%
		...
		OVERALL_ASIM_KATI = Request.Form("OVERALL_ASIM_KATI")
		...
		Cmd.Parameters("@OVERALL_ASIM_KATI").Value =ConvertNumeric(OVERALL_ASIM_KATI)
%>		

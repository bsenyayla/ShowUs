...
public partial class SweepInstructionsVirmanTransactionList : BasePage
{
    ...
    protected void GpCorporatedPreInfoListReload(object sender, AjaxEventArgs e)
    {
        ...
        string strSql;
            ...
            strSql = @"SELECT V.New_VirmanId Id,
                        ...
                        INNER JOIN vNew_SweepInstructionsTransaction SIT (NOLOCK) ON SIT.new_VirmanId = V.New_VirmanId
                        WHERE V.DeletionStateCode = 0 
	                        AND SIT.DeletionStateCode = 0 ";

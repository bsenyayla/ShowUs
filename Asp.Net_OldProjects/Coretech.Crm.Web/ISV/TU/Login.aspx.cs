...
public partial class Login : RefleXPage
{
    void TranslateMessage()
    {
        txtUsername.FieldLabel = CrmLabel.TranslateMessageNotLogin("LOGIN_USERNAME", LangId);
        txtPassword.FieldLabel = CrmLabel.TranslateMessageNotLogin("LOGIN_PASSWORD", LangId);
        Reminder.Text = CrmLabel.TranslateMessageNotLogin("LOGIN_REMINDPASSWORD", LangId);

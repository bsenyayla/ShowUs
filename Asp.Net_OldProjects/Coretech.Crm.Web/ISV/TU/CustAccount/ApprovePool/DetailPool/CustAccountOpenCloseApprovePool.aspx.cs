...
public partial class CustAccount_ApprovePool_DetailPool_CustAccountOpenCloseApprovePool : BasePage
{
    ...
    protected void GpCustAccountOperationHeaderReload(object sender, AjaxEventArgs e)
    {
        ...
        string strFilterSql = approvePoolService.GetFiltersForCustAccountOpenCloseApproveList(out spList, new_CustAccountTypeId, new_SenderId
            , new_CustAccountOperationTypeId, new_CorporationId, new_OfficeId, CreatedOnS, CreatedOnE, new_CustAccountApprovePoolStatusRef);
        GridDataResponse gdr = approvePoolService.GetCustAccountOpenCloseApproveList(gpCustAccountOperationHeader, viewqueryid, strFilterSql, spList);
    ...
    {
        return "CUSTACCOUNT_OPERATIONS_APPROVEPOOLLIST";
    }

<%@ Page Language="C#" AutoEventWireup="true" Inherits="CustAccount_ApprovePool_DetailPool_CustAccountBlockApprove" Codebehind="CustAccountBlockApprove.aspx.cs" %>
                    ...
                    <Rows>
                        <rx:RowLayout runat="server" ID="RowLayout10">
                         ...
                         <rx:RowLayout ID="RowLayout11" runat="server">
                            <Body>
                                <cc1:CrmPicklistComp ID="new_BlockedConfirmStatus" runat="server" ObjectId="201600006" UniqueName="new_BlockedConfirmStatus">
                                </cc1:CrmPicklistComp>
                            </Body>
                        </rx:RowLayout>
                    </Rows>
        ...
        <rx:GridPanel runat="server" ID="gpCustAccountOperationHeader" AutoWidth="true" AutoHeight="Auto"
            ...
            <SelectionModel>
                <rx:RowSelectionModel ID="gpCustAccountOperationHeaderRowSelectionModel1" runat="server" 
                    ShowNumber="true">
                    <Listeners>
                        <RowDblClick Handler="ShowEditWindow(gpCustAccountOperationHeader.id,gpCustAccountOperationHeader.selectedRecord.ID,null,'201600006');" />
                    </Listeners>

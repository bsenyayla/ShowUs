<%@ Page Language="C#" AutoEventWireup="true" Inherits="CustAccount_Pool_UptCardTransactionPool" Codebehind="UptCardTransactionPool.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rx:KeyMap runat="server" ID="KeyMap1">
            <rx:KeyBinding>
                <Keys>
                    <rx:Key Code="F9">
                        <Listeners>
                            <Event Handler="gpUptCardOperationHeader.reload();" />
                        </Listeners>
                    </rx:Key>
                </Keys>
            </rx:KeyBinding>
        ...
        <rx:PanelX runat="server" ID="pnl1" AutoHeight="Normal" Height="90" AutoWidth="true" Collapsed="false" Collapsible="False"
                ...
                <rx:ColumnLayout runat="server" ID="ColoumnLayout1" ColumnWidth="33%">
                    <Rows>
                        ...
                        <rx:RowLayout ID="RowLayout3" runat="server">
                            <Body>
                                <cc1:CrmTextFieldComp ID="CardNumber" runat="server" UniqueName="CardNumber" ObjectId="201600019" FieldLabel="100" Width="200">
            ...
            <Buttons>
                <rx:Button runat="server" ID="btnTransferToUptCard" Text="Upt Karta Para Yatır" Icon="Add"
                    Width="120">
                    <Listeners>
                        <Click Handler="ShowRequestWindow(gpUptCardOperationHeader.id,Upt.CustOperation.TransferToUptCard)"></Click>
                    </Listeners>
                </rx:Button>
                <rx:Button runat="server" ID="btnRefresh" Text="" Icon="Magnifier"
                    Width="120">
                    <Listeners>
                        <Click Handler="gpUptCardOperationHeader.reload();"></Click>
                    </Listeners>
                </rx:Button>
            </Buttons>
        </rx:PanelX>
         <rx:GridPanel runat="server" ID="gpUptCardOperationHeader" AutoWidth="true" AutoHeight="Auto"
            Height="150" Editable="false" Mode="Remote" AutoLoad="false" Width="1200" AjaxPostable="true">
             <Tools>
                <Items>
                    <rx:ToolButton runat="server" ID="ToolButton1" ToolTypeIcon="Maximize">
                        <Listeners>
                            <Click Handler="gpUptCardOperationHeader.fullScreen();" />
                        </Listeners>
                    </rx:ToolButton>
                </Items>
            </Tools>
             <DataContainer>
                <DataSource OnEvent="GpUptCardOperationHeaderReload">
                </DataSource>
                <Parameters>
             ...
             <SelectionModel>
                <rx:RowSelectionModel ID="gpUptCardOperationHeaderRowSelectionModel1" runat="server" ShowNumber="true"
                    SingleSelect="true">
                    <Listeners>
                        <RowDblClick Handler="ShowRequestWindow(gpUptCardOperationHeader.id,Upt.CustOperation.ReadOnly, gpUptCardOperationHeader.selectedRecord.ID);" />
                    </Listeners>
                </rx:RowSelectionModel>
            </SelectionModel>
             <BottomBar>
                <rx:PagingToolBar runat="server" ID="PagingToolBar1" ControlId="gpUptCardOperationHeader">
                </rx:PagingToolBar>
            </BottomBar>

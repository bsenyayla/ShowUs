<%@ Page Language="C#" AutoEventWireup="true" Inherits="CustAccount_Pool_CustAccountOperationPool" CodeBehind="CustAccountOperationPool.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rx:PanelX runat="server" ID="pnl1" AutoHeight="Normal" Height="90" AutoWidth="true" Collapsed="true" Collapsible="true"
                                ...
                                <rx:MultiField runat="server" ID="mfsender" FieldLabelShow="True">
                                    <Items>
                                        <cc1:CrmComboComp ID="new_SenderId" runat="server" ObjectId="201500039" UniqueName="new_SenderId"
                                            FieldLabelWidth="100" Width="250" PageSize="50" FieldLabelShow="False">
                                            <Filters>
         ...
         <rx:PanelX runat="server" ID="pnl2" AutoHeight="Normal"  AutoWidth="true" Collapsed="false" Collapsible="False"
            Border="false" Frame="false">
               <Buttons>
                <%-- <rx:Button runat="server" ID="btnAddNewCustAccountOperation" Text="Yeni Hesap Yarat" Icon="Add"
                    Width="120">
                    <Listeners>
                        <Click Handler="ShowRequestWindow(gpCustAccountOperationHeader.id,Upt.CustOperation.Insert)"></Click>
                    </Listeners>
                </rx:Button>--%>
                <rx:Button runat="server" ID="btnDeleteNewCustAccountOperation" Text="Hesap Sil" Icon="Delete"
                    Width="120">
                    <Listeners>
                        <Click Handler="ShowRequestWindow(gpCustAccountOperationHeader.id,Upt.CustOperation.Delete)"></Click>
                    </Listeners>
                </rx:Button>

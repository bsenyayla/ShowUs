<%@ Page Language="C#" AutoEventWireup="true" Inherits="CustAccount_Pool_CustAccountTransferPool" CodeBehind="CustAccountTransferPool.aspx.cs" %>
                ...
                <rx:ColumnLayout runat="server" ID="ColoumnLayout2" ColumnWidth="30%">
                    <Rows>
                        <rx:RowLayout ID="RowLayout8" runat="server">
                            <Body>
                                <cc1:CrmPicklistComp ID="new_TransferType" runat="server" ObjectId="201900032" UniqueName="new_TransferType"
                                    FieldLabelWidth="100" Width="130" PageSize="50">
                                </cc1:CrmPicklistComp>
        ...
        <rx:GridPanel runat="server" ID="gpCustAccountOperationHeader" AutoWidth="true" AutoHeight="Auto"
            ...
            <SelectionModel>
                <rx:RowSelectionModel ID="gpCustAccountOperationHeaderRowSelectionModel1" runat="server" ShowNumber="true"
                    SingleSelect="true">
                    <Listeners>
                        <RowDblClick Handler="ShowAccountTransferWindow(gpCustAccountOperationHeader.id, gpCustAccountOperationHeader.selectedRecord.ID);" />
                    </Listeners>
...
<script type="text/javascript">
    ...
    function ShowAccountTransferWindow(GridId, id) {

        var url = window.top.GetWebAppRoot;

        url += "/ISV/TU/CustAccount/Pool/AccountTransfer.aspx";

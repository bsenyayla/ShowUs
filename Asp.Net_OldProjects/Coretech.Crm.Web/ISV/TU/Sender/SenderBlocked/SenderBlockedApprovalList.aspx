<%@ Page Language="C#" AutoEventWireup="true" Inherits="SenderBlockedApprovalList" Codebehind="SenderBlockedApprovalList.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ShowDetail() {
            ...
            var config = "/CrmPages/AutoPages/EditReflex.aspx?ObjectId=201900037&recId=" + blockedId.getValue() + "&defaulteditpageid=" + defaulteditpageid + "&SourceFormType=ApprovalList";
            window.top.newWindow(config, { title: 'Bloke Işlemi', width: 700, height: 300, resizable: false });
            */
            if (corporateType.getValue() == 1) {
                defaulteditpageid = "1433D224-D027-EA11-A76F-A01D480B4D85";
                var config = "/CrmPages/AutoPages/EditReflex.aspx?ObjectId=201900037&recId=" + blockedId.getValue() + "&defaulteditpageid=" + defaulteditpageid + "&SourceFormType=ApprovalList";
                window.top.newWindow(config, { title: 'Bloke Onay Işlemi', width: 700, height: 300, resizable: false });
            } else {
                defaulteditpageid = "C40A4F65-D027-EA11-A76F-A01D480B4D85";
                var config = "/ISV/TU/Sender/SenderBlocked/SenderPersonBlockedForm.aspx?SourceForm=CustomerAccount&fromCustomerAccountScreen=2&RecordId=" + blockedId.getValue() + "&SourceFormType=ApprovalList";
                window.top.newWindow(config, { title: 'Bloke Onay Işlemi', width: 700, height: 500, resizable: false });
            }
        }
...
<Body>
            ...
            <Buttons>
                ...
                <rx:Button runat="server" ID="btnCancel" Text="Reddet" Icon="Cancel"
                    Width="120">
                    <AjaxEvents>
                      <Click OnEvent="btnbtnCancelEditUpdate_Click" ></Click>
                  </AjaxEvents>
                </rx:Button>
            ...
            Height="150" Editable="false" Mode="Remote" AutoLoad="false" Width="1200" AjaxPostable="true">
                ...
                <SelectionModel>
                    <rx:RowSelectionModel ID="gpSenderDocumentRowSelectionModel" runat="server" ShowNumber="true"
                        SingleSelect="true">
                        <Listeners>
                            <RowClick Handler="blockedId.setValue(GridPanelCorporateBlockedList.selectedRecord.Id);transactionTypeId.setValue(GridPanelCorporateBlockedList.selectedRecord.TransactionType);corporateType.setValue(GridPanelCorporateBlockedList.selectedRecord.CorporateType);"></RowClick>

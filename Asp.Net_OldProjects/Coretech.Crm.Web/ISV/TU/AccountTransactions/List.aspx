<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Coretech.Crm.Web.ISV.TU.AccountTransactions.List" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <rx:PanelX runat="server" ID="pSearch" AutoHeight="Normal" Height="25" AutoWidth="true" Border="true" Frame="true" Title="Hesap Hareketleri">
                <Body>
                    <rx:ColumnLayout runat="server" ID="cl1" ColumnWidth="23%">
                        <Rows>
                            <rx:RowLayout ID="rl1" runat="server">
                                <Body>
                                    <rx:TextField ID="tReference" runat="server" FieldLabel="Referans"></rx:TextField>
                                </Body>
                            </rx:RowLayout>
                        </Rows>
                    </rx:ColumnLayout>
                    ...
                    <rx:ColumnLayout runat="server" ID="cl3" ColumnWidth="14%">
                        <Rows>
                            <rx:RowLayout runat="server" ID="rl3">
                                <Body>
                                    <rx:Button ID="bExcel" runat="server" Text="Excel'e Aktar" Icon="PageExcel" Download="true" Width="150">
                                        <AjaxEvents>

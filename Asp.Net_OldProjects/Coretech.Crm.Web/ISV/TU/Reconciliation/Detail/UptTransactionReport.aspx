<%@ Page Language="C#" AutoEventWireup="true" Inherits="Reconciliation.Detail.Reconciliation_Detail_UptTransactionReport" ValidateRequest="false" CodeBehind="UptTransactionReport.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowUptWindow(UptReference, BankTransactionNumber) {
            var url = window.top.GetWebAppRoot + "/ISV/TU/Reconciliation/Detail/UptTransactionReportDetail.aspx?UptReference=" + UptReference + "&BankTransactionNumber=" + BankTransactionNumber;
...
<body>
    <form id="form1" runat="server">
        ...
        <rx:PanelX runat="server" ID="PanelX1" AutoHeight="Normal" Height="90" AutoWidth="true" Border="false">
            <Body>
                <rx:ColumnLayout runat="server" ID="ColoumnLayout1" ColumnWidth="30%">
                    <Rows>
                        ...
                        <rx:RowLayout runat="server" ID="RowLayout5">
                            <Body>
                                <rx:ComboField ID="cmbTrasactionTypeCode" runat="server" FieldLabel="İşlem Türü">
                                    <Items>
                                        <rx:ListItem Text="-TÜMÜ-" Value="0" />
                                        <rx:ListItem Text="Alıcı Tr'de - UP001" Value="1" />
                                        <rx:ListItem Text="Gönderici Tr'de - UP002" Value="2" />
                                    </Items>
                                </rx:ComboField>
                            </Body>
                        </rx:RowLayout>
                ...
                <rx:ColumnLayout runat="server" ID="ColoumnLayout3" ColumnWidth="25%">
                    <Rows>
                        ...
                        <rx:RowLayout runat="server" ID="RowLayout8">
                            <Body>
                                <rx:Button runat="server" ID="btnXmlExport" Text="Xml Aktar" Icon="Folder" Download="true"
                                    Width="200">
                                    <AjaxEvents>
                                        <Click OnEvent="ToXmlExport" Success="Ext.net.DirectMethods.Download({ isUpload : true });" >
                                        </Click>
                                    </AjaxEvents>

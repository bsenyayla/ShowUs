<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="Reconciliation.Detail.Reconciliation_Ab2" Async="true" Codebehind="_Ab2.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShowTotalWindow(ReconciliationId) {
            var url = window.top.GetWebAppRoot + "/ISV/TU/Reconciliation/Detail/AbTotal.aspx?ReconciliationId=" + ReconciliationId;
...
<body>
    <form id="form1" runat="server">
        ...
        <rx:PanelX runat="server" ID="pnl1" AutoHeight="Normal" Height="500" AutoWidth="true"
                ...
                <rx:GridPanel runat="server" ID="GrdReConciliation" Title="ReConciliation List" Height="400"
                    ...
                    <ColumnModel>
                        <Columns>
                            ...
                            <rx:GridColumns ColumnId="TU_ISLEMKODU" Width="0" Header="TU_ISLEMKODU" Sortable="false"
                                MenuDisabled="true" Hidden="true" DataIndex="TU_ISLEMKODU" />
                            ...
                            <rx:GridColumns ColumnId="TRANSFER_TU_REF" Width="150" Header="UPT Referans" Hidden="true" Sortable="false"
                                MenuDisabled="true" DataIndex="TRANSFER_TU_REF">
                            </rx:GridColumns>
                            <rx:GridColumns ColumnId="MASTER_TRANSFER_TU_REF" Width="150" Header="UPT Referans" Sortable="false"
                                MenuDisabled="true" DataIndex="MASTER_TRANSFER_TU_REF">
                                <Commands>
            ...
            <Buttons>
                <rx:Button runat="server" ID="btnAbTotal" Text="(F9)" Icon="ApplicationGo"
                    Width="200">
                    <AjaxEvents>

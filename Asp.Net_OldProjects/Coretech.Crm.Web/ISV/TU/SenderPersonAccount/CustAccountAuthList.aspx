<%@ Page Language="C#" AutoEventWireup="true" Inherits="Sender_CustAccountAuthList" ValidateRequest="false" CodeBehind="CustAccountAuthList.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rx:KeyMap runat="server" ID="KeyMap1">
            <rx:KeyBinding>
                <Keys>
                    <rx:Key Code="F9">
                        <Listeners>
                            <Event Handler="GpCustAccountsAuth.reload();" />
                        </Listeners>
                    </rx:Key>
                </Keys>
            </rx:KeyBinding>
        ...
        <rx:PanelX runat="server" ID="pnl1" AutoHeight="Normal" Height="110" AutoWidth="true" Collapsed="false" Collapsible="False"
            ...
            <Buttons>
                <rx:Button runat="server" ID="btnNewAuth" Text="Yeni" Icon="PageAdd"
                    Width="50">
                    <AjaxEvents>
                        <Click OnEvent="btnNewAuth_Click"></Click>
                    </AjaxEvents>
                </rx:Button>
                <rx:Button runat="server" ID="btnRefresh" Text="" Icon="Magnifier"
                    Width="30">
                    <Listeners>
                        <Click Handler="GpCustAccountsAuth.reload();"></Click>
                    </Listeners>
                </rx:Button>
            </Buttons>

        </rx:PanelX>
        <rx:GridPanel runat="server" ID="GpCustAccountsAuth" AutoWidth="true" AutoHeight="Auto"
            Height="150" Editable="false" Mode="Remote" AutoLoad="false" Width="1200" AjaxPostable="true">
            <DataContainer>
                <DataSource OnEvent="GpCustAccountsAuthReload">
                </DataSource>
                <Parameters>
            ...
            <ColumnModel>
                <Columns>
                    ...
                    <rx:GridColumns ColumnId="new_AuthType" Width="100" Header="Yetki Tipi" Sortable="false"
                     ...
                     <rx:GridColumns ColumnId="ConfirmStatus" Width="100" Header="Onay Durumu" Sortable="false"
                        MenuDisabled="true" Hidden="false" DataIndex="ConfirmStatus" />
                </Columns>
            </ColumnModel>
            <SelectionModel>
                <rx:RowSelectionModel ID="GpCustAccountsAuthRowSelectionModel" runat="server" ShowNumber="true"
                    SingleSelect="true">
                    <AjaxEvents>
                        <RowDblClick Before="hdnCustAccountAuthID.setValue(GpCustAccountsAuth.selectedRecord.ID);"
            ...
            <BottomBar>
                <rx:PagingToolBar runat="server" ID="PagingToolBar2" ControlId="GpCustAccountsAuth">
                </rx:PagingToolBar>
            </BottomBar>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LimitApproverManagementHeader.aspx.cs" Inherits="Coretech.Crm.Web.ISV.TU.LimitApproverManagement.LimitApproverManagementHeader" ValidateRequest="false" %>
...
<%--                               <cc1:CrmComboComp runat="server" id="new_SenderPersonId" objectid="202000027" uniquename="new_SenderPersonId"
            ...
            <rx:GridPanel runat="server" ID="GridPanelSenderPerson" AutoWidth="true" AutoHeight="Auto" AutoScroll="true"
                Height="500" Width="1200" Mode="Remote" AjaxPostable="true" Editable="false" Visible="false">
                <DataContainer>

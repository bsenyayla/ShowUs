<%@ Page Language="C#" AutoEventWireup="true" Inherits="Fraud_Detail_ConfirmAccount" Codebehind="_ConfirmAccount.aspx.cs" %>
                ...
                <rx:ColumnLayout runat="server" ID="ColoumnLayout1" ColumnWidth="100%">
                    <Rows>
                        <rx:RowLayout ID="RowLayout1" runat="server">
                            <Body>
                                <cc1:CrmComboComp runat="server" ID="new_FraudContinueReasonId" ObjectId="201500043"
                                    UniqueName="new_CustAccountFraudContinueReasonId" FieldLabelWidth="120" Width="130" PageSize="50"
                                    RequirementLevel="BusinessRequired" LookupViewUniqueName="FRAUDCUSTACCOUNT_DEVAMETTIRME">
                                </cc1:CrmComboComp>
                            </Body>
                        </rx:RowLayout>
                        <rx:RowLayout runat="server" ID="RowLayout2">
                            <Body>
                                <cc1:CrmTextAreaComp ID="new_FraudContinueReason" runat="server" ObjectId="201500043"
            ...
            <rx:ColumnLayout runat="server" ID="ColumnLayout1" ColumnWidth="100%">
                <Rows>
                    <rx:RowLayout ID="RowLayout3" runat="server">
                        <Body>
                            <cc1:CrmComboComp runat="server" ID="new_FraudCancelReasonId" ObjectId="201500043"
                                UniqueName="new_CustAccountFraudCancelReasonId" FieldLabelWidth="120" Width="130" PageSize="50"
                                RequirementLevel="BusinessRequired" LookupViewUniqueName="FRAUDCUSTACCOUNT_KESME">
                            </cc1:CrmComboComp>
                        </Body>
                    </rx:RowLayout>
                    <rx:RowLayout runat="server" ID="RowLayout4">
                        <Body>
                            <cc1:CrmTextAreaComp ID="new_FraudCancelReason" runat="server" ObjectId="201500043"
            ...
            <rx:ColumnLayout runat="server" ID="ColumnLayout2" ColumnWidth="100%">
                <Rows>
                    <rx:RowLayout ID="RowLayout5" runat="server">
                        <Body>
                            <cc1:CrmComboComp runat="server" ID="new_FraudConfirmCancelReasonId" ObjectId="201500043"
                                UniqueName="new_CustAccountFraudConfirmCancelReasonId" FieldLabelWidth="120" Width="130"
                                PageSize="50" RequirementLevel="BusinessRequired" LookupViewUniqueName="FRAUDCUSTACCOUNT_ONAYCI_KESME">
                            </cc1:CrmComboComp>
                        </Body>
                    </rx:RowLayout>
                    <rx:RowLayout runat="server" ID="RowLayout6">
                        <Body>
                            <cc1:CrmTextAreaComp ID="new_FraudConfirmCancelReason" runat="server" ObjectId="201500043"

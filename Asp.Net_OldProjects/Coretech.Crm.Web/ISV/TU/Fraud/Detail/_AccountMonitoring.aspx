<%@ Page Language="C#" AutoEventWireup="true" Inherits="Fraud_Detail_AccountMonitoring" Codebehind="_AccountMonitoring.aspx.cs" %>
        ...
        <rx:GridPanel runat="server" ID="GridPanelAccountMonitoring" AutoWidth="true" AutoHeight="Auto"
            ...
            <SelectionModel>
                <rx:RowSelectionModel ID="GridPanelAccountMonitoringRowSelectionModel1" runat="server" ShowNumber="true">
                    <Listeners>
                        <RowDblClick Handler="ShowWindowReadOnly(GridPanelAccountMonitoring.id,GridPanelAccountMonitoring.selectedRecord.ID);" />
                    </Listeners>

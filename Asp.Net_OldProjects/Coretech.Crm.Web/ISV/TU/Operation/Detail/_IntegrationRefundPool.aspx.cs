...
public partial class Operation_Detail_IntegrationRefundPool : BasePage
{
...
Mt.new_SerialNumber,
                ...
                Mt.new_ReceivedPaymentAmountCurrencyName AS new_ReceivedPaymentAmount_CurrencyName,
                Mt.new_SenderIdendificationNumber1
from  dbo.tvNew_ProcessMonitoring(@SystemUserId) as Mt
Where
     Mt.New_ConfirmStatus IN (Select New_ConfirmStatusId From vNew_ConfirmStatus(NOLOCK) WHERE DeletionStateCode=0 AND new_Code = 'TR000R')   
    ...
    {
        var id = Guid.Parse("3ca31e3a-da9d-445c-b3c5-0733be6270f0");

<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="Operation_Detail_IntegrationRefundPool" ValidateRequest="false" CodeBehind="_IntegrationRefundPool.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rx:Hidden ID="hdnPoolId" runat="server" Value="5">
        </rx:Hidden>
        ...
        <rx:GridPanel runat="server" ID="GridPanelMonitoring" AutoWidth="true" AutoHeight="Auto"
            ...
            <SelectionModel>
                <rx:RowSelectionModel ID="GridPanelMonitoringRowSelectionModel1" runat="server" ShowNumber="true"
                    SingleSelect="true">
                    <Listeners>
                        <RowDblClick Handler="ShowWindow(GridPanelMonitoring.id,GridPanelMonitoring.selectedRecord.ID,GridPanelMonitoring.selectedRecord.ObjectId,6);" />
                    </Listeners>

...
function ShowEntegrationLog() {
    var config = "../ISV/TU/Operation/Detail/EntegrationLog.aspx?EntityId=" + hdnEntityId.getValue() + "&RecordId=" + hdnRecid.getValue();
    window.top.newWindow(config, { title: 'EntegrationLogViewer', width: 800, height: 500, resizable: false });
}
<%@ Page Language="C#" AutoEventWireup="true" Inherits="Operation_Detail_Monitoring" Codebehind="_PTTPool.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width: 100%">
            <tr>
                <td>
                    <rx:PanelX runat="server" ID="pnl1" AutoHeight="Normal" Height="232" AutoWidth="true"
                            ...
                            <rx:ColumnLayout runat="server" ID="ColoumnLayout1" ColumnWidth="35%">
                                <Rows>
                                    <rx:RowLayout ID="RowLayout1" runat="server">
                                        <Body>
                                            <cc1:CrmComboComp ID="new_SenderCountryID" runat="server" ObjectId="201400019" UniqueName="new_SenderCountryID"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout4">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_CorporationId" ObjectId="201400019" UniqueName="new_CorporationId"
                                                FieldLabelWidth="100" Width="130" PageSize="50">
                                                <Filters>
                                    ...
                                    <rx:RowLayout runat="server">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_OfficeId" ObjectId="201400019" UniqueName="new_OfficeId"
                                                FieldLabelWidth="100" Width="130" PageSize="50">
                                                <Filters>
                                                    <cc1:ComboFilter FromObjectId="201400019" FromUniqueName="new_CorporationId" ToObjectId="201100040"
                                                        ToUniqueName="new_CorporationID" />
                                                </Filters>
                                            </cc1:CrmComboComp>
                                            <%--<cc1:CrmComboComp runat="server" ID="CrmComboComp3" ObjectId="201400019" UniqueName="New_OfficeId"
                                                FieldLabelWidth="100" Width="130" PageSize="50">
                                                <Filters>
                                                    <cc1:ComboFilter FromObjectId="201100034" FromUniqueName="new_CorporationId" ToObjectId="201100040"
                                                        ToUniqueName="new_CorporationID" />
                                                </Filters>
                                            </cc1:CrmComboComp>--%>
                                        </Body>
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout16">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_PayingCorporationId" ObjectId="201400019" UniqueName="new_PayingCorporationId"
                                                FieldLabelWidth="100" Width="130" PageSize="50">
                                            </cc1:CrmComboComp>
                                        </Body>
                                    </rx:RowLayout>
                                    <rx:RowLayout runat="server" ID="RowLayout9">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_FormConfirmStatusId" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout19">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_FileTransactionNumber" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout18">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_QueryNo" ObjectId="201400019"
                                                UniqueName="new_QueryNo" FieldLabelWidth="70" Width="230" PageSize="50">
                                            </cc1:CrmTextFieldComp>
                                        </Body>
                                    </rx:RowLayout>
                                    <rx:RowLayout runat="server" ID="RowLayout20">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_PTTTransferNo" ObjectId="201400019"
                                                UniqueName="new_PTTTransferNo" FieldLabelWidth="70" Width="230" PageSize="50">
                                            </cc1:CrmTextFieldComp>
                                        </Body>
                                    </rx:RowLayout>
                                    <rx:RowLayout runat="server" ID="RowLayout21">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_TCKN_YKN_VKN" ObjectId="201400019"
                                                UniqueName="new_TCKN_YKN_VKN" FieldLabelWidth="70" Width="230" PageSize="50">
                                            </cc1:CrmTextFieldComp>
                                        </Body>
                                    </rx:RowLayout>
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout23">
                                        <Body>
                                            <cc1:CrmBooleanComp runat="server" ID="new_IsRefund" ObjectId="201400019"
                                                UniqueName="new_IsRefund" FieldLabelWidth="70" Width="230" PageSize="50">
                                            </cc1:CrmBooleanComp>
                                        </Body>
                                    </rx:RowLayout>
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout2">
                                        <Body>
                                            <rx:MultiField ID="RxM" runat="server">
                                                <Items>
                                                    <cc1:CrmDateFieldComp ID="new_FormTransactionDate1" runat="server" ObjectId="201400019"
                                                    ...
                                                    <cc1:CrmDateFieldComp ID="new_FormTransactionDate2" runat="server" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout3">
                                        <Body>
                                            <rx:MultiField ID="MultiField1" runat="server">
                                                <Items>
                                                    <cc1:CrmDecimalComp ID="new_FormAmount1" runat="server" ObjectId="201400019" UniqueName="new_FormAmount1"
                                                        FieldLabelWidth="110" Width="100">
                                                    </cc1:CrmDecimalComp>
                                                    <rx:Label runat="server" Text="  " ID="Label1" Width="10">
                                                    </rx:Label>
                                                    <cc1:CrmDecimalComp ID="new_FormAmount2" runat="server" ObjectId="201400019" FieldLabelShow="false"
                                                        UniqueName="new_FormAmount2" FieldLabelWidth="100" Width="100">
                                                    </cc1:CrmDecimalComp>
                                                    <rx:Label runat="server" Text="  " ID="Label3" Width="10" />
                                                    <cc1:CrmComboComp runat="server" ID="new_FormTransactionAmountCurrency" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout12">
                                        <Body>
                                            <rx:MultiField ID="MultiField12" runat="server">
                                                <Items>
                                                    <cc1:CrmTextFieldComp ID="PTTProcessMonitoring" runat="server" ObjectId="201400019"
                                                        UniqueName="PTTProcessMonitoring" FieldLabelWidth="110" Width="230">
                                                    </cc1:CrmTextFieldComp>
                                                </Items>
                                            </rx:MultiField>
                                        </Body>
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout10">
                                        <Body>
                                            <rx:MultiField ID="MultiField2" runat="server">
                                                <Items>
                                                    <cc1:CrmPicklistComp runat="server" ID="new_OperationType" ObjectId="201400019" UniqueName="new_OperationType"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout22">
                                        <Body>
                                            <rx:MultiField ID="MultiField3" runat="server">
                                                <Items>
                                                    <cc1:CrmDateFieldComp ID="new_PaymentDate2" runat="server" DateMode="Date" ObjectId="201400019"
                                                        UniqueName="new_PaymentDate2" FieldLabelWidth="110" Width="100" MaxLength="300">
                                                    </cc1:CrmDateFieldComp>
                                                    <rx:Label runat="server" Text="  " ID="Label2" Width="10">
                                                    </rx:Label>
                                                    <cc1:CrmDateFieldComp ID="new_PaymentDate3" runat="server" ObjectId="201400019" FieldLabelShow="false"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout14">
                                        <Body>
                                            <%--<rx:MultiField ID="MultiField4" runat="server">
                                                <Items>
                                                    <cc1:CrmDateFieldComp ID="new_CancelDate1" runat="server" DateMode="Date" ObjectId="201400019"
                                                        UniqueName="new_CancelDate" FieldLabelWidth="110" Width="100" MaxLength="300">
                                                    </cc1:CrmDateFieldComp>
                                                    <rx:Label runat="server" Text="  " ID="Label4" Width="10">
                                                    </rx:Label>
                                                    <cc1:CrmDateFieldComp ID="new_CancelDate2" runat="server" DateMode="Date" ObjectId="201400019"
                            ...
                            <rx:ColumnLayout runat="server" ID="ColumnLayout1" ColumnWidth="25%">
                                <Rows>
                                    <rx:RowLayout runat="server" ID="RowLayout6">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_FormTransactionTypeEft" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout17">
                                        <Body>
                                            <%--<rx:MultiField ID="MultiField5" runat="server">
                                                <Items>
                                                    <cc1:CrmPicklistComp runat="server" ID="new_FormTransactionTypeEft" ObjectId="201400019" UniqueName="new_FormTransactionTypeID"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout13">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_FormSourceTransactionTypeID" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout7">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_FormReceiverCountryId" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout5">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_FormCustomerNumber" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout8">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_SenderId" ObjectId="201400019" UniqueName="new_SenderId"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout11">
                                        <Body>
                                            <cc1:CrmTextFieldComp runat="server" ID="new_RecipientFullName" ObjectId="201400019"
                                    ...
                                    <rx:RowLayout runat="server" ID="RowLayout15">
                                        <Body>
                                            <cc1:CrmComboComp runat="server" ID="new_RecipientCorporationId" ObjectId="201400019" UniqueName="new_RecipientCorporationId"
                                     ...
                                     <%--<rx:RowLayout runat="server" ID="RowLayout18">
                                        <Body>
                                            <cc1:CrmPicklistComp runat="server" ID="new_Channel" ObjectId="201400019" UniqueName="new_Channel"
                                                FieldLabelWidth="70" Width="230" PageSize="50">
                                            </cc1:CrmPicklistComp>
                                        </Body>
                                    </rx:RowLayout>--%>
            ...
            <BottomBar>
                <rx:PagingToolBar runat="server" ID="PagingToolBar1" ControlId="GridPanelMonitoring">
                    <Buttons>
                        ...
                        <rx:SmallButton ID="BtnSb1" Icon="Database" Text="CRM.NEW_PTTPROCESSMONITORING_LIST_TOTAL">
                            <AjaxEvents>
        ...
        <rx:Window ID="windowTotal" runat="server" Width="500" Height="200" Modal="true"
            ...
            Title="CRM.NEW_PTTPROCESSMONITORING_LIST_TOTAL">
            <Body>

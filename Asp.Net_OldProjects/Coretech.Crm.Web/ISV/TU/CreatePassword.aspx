<%@ Page Language="C#" AutoEventWireup="true" Inherits="CreatePassword" CodeBehind="CreatePassword.aspx.cs" %>
...
<body style="background-image: url(~images/desktop.jpg)">
    <form id="form1" runat="server">
        ...
        <rx:Hidden ID="hdnIsFromOtpChannel" runat="server" />
        ...
        <rx:Window runat="server" Width="600" Height="165" ID="PnlWindow" Closable="false"
            Shadow="false" Animate="true" CenterOnResize="true" Maximizable="false" CenterOnLoad="true"
            Dragable="false" Resizable="false">
            <Body>
                <rx:PanelX runat="server" ID="pnlx" AutoWidth="true" AutoHeight="Auto" Height="135"
                    ...
                    <Body>
                        <rx:ColumnLayout runat="server" ID="ColumnLayout1" ColumnWidth="100%">
                            <Rows>
                                ...
                                <rx:RowLayout runat="server" ID="RowLayout5" RowStyle="margin-left:5px;">
                                    <Body>
                                        <rx:TextField FType="Password" FieldLabel="Tekrar Şifre" runat="server" ID="txtPasswordAgain"
                                            Width="100" />
                                    </Body>
                                </rx:RowLayout>

<%@ Page Language="C#" AutoEventWireup="true" Inherits="CrmPages_Admin_Customization_Entity_EntityEdit" Codebehind="EntityEdit.aspx.cs" %>
        ...
        if (value != "") {
            ...
            switch (action) {
                ...
                case 4: url = "Property/AttributeListReflex.aspx?Time=" + Date();
                    break;
                case 5: url = "Property/RelationshipListReflex.aspx?Time=" + Date() + "&reelationType=0";
                    break;
                case 6: url = "Property/RelationshipListReflex.aspx?Time=" + Date() + "&reelationType=1";
                    break;
                case 7: url = "Property/RelationshipN2NReflex.aspx?Time=" + Date() + "&reelationType=2";
                    break;

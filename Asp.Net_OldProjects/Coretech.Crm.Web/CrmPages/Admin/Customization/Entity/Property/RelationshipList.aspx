<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CrmPages_Admin_Customization_Entity_Property_RelationshipList" Codebehind="RelationshipList.aspx.cs" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="LookupTypeValue" Type="Int" />
                            ...
                            <ext:Panel ID="Panel2" runat="server" Frame="false" Border="false" LabelSeparator="">
                                <Body>
                                    <ext:FormLayout ID="FormLayout1" runat="server" LabelSeparator="">
                                        ...
                                        <ext:Anchor>
                                            <ext:ComboBox runat="server" ID="Format" FieldLabel="Format" Width="150" Editable="false">
                                            </ext:ComboBox>
                                        </ext:Anchor>
                                    </ext:FormLayout>
                                </Body>
                        ...
                        <ext:GridPanel ID="_grdsma" runat="server" AutoWidth="true" StripeRows="true" StoreID="store1"
                            ...
                            <ColumnModel ID="_columnModel2" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column Header="LookupTypeValue" DataIndex="LookupTypeValue" Width="150" Hidden="true" />

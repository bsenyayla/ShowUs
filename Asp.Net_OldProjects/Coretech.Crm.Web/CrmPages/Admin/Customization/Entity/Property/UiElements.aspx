<%@ Page Language="C#" AutoEventWireup="true" Inherits="CrmPages_Admin_Customization_Entity_Property_FormAndView" Codebehind="UiElements.aspx.cs" %>
...
<head runat="server">
    ...
    <script language="javascript">
        function ShowWindow(sender, arg) {
            var config = "Admin/Customization/Entity/Property/ViewEdit.aspx?objectid=" + hdnObjectId.value;
            if (arg == 0) {
                config = config + "&id=";
            }
            else {
                config = config + "&id=" + sender.getRowsValues()[0].ViewQueryId;
            }
            //object.load(config)
            //object[0].id
            //show(animateTarget, cb, scope)	Variant
            window.top.newWindow(config, { title: 'ViewEdit', width: 800, height: 400, resizable: true, maximizable: true });
                ...
                <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" TrackMouseOver="false">
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column Header="ViewQueryId" DataIndex="ViewQueryId" Width="100" Hidden="true"
                                Sortable="false">
                            </ext:Column>
                            <ext:Column Header="UniqueName" DataIndex="UniqueName" Width="70" Align="right" Hidden="true"
                                Sortable="false">
                            </ext:Column>
                        </Columns>
                    </ColumnModel>

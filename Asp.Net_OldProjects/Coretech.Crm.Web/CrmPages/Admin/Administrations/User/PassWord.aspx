<%@ Page Language="C#" AutoEventWireup="true" Inherits="CrmPages_Admin_Administrations_User_PassWord" Codebehind="PassWord.aspx.cs" %>
...
<body>
    ...
    <rx:PanelX runat="server"  ID="panel1" AutoHeight="Normal" Height="130" AutoWidth="true"
        >
        <Body>
        ...
        <Buttons>
            <rx:Button runat="server" ID="Save" Text="Save" Icon="DiskBlack"
                Width="100">
                <AjaxEvents>

<%@ Page Language="C#" AutoEventWireup="true" Inherits="CrmPages_Admin_CustomControl_CustomControlList" Codebehind="CustomControlList.aspx.cs" %>
...
<body>
    ...
    <ext:Hidden ID="hCustomControlDllId" runat="server">
    </ext:Hidden>
    <ext:Store ID="Store1" runat="server" AutoLoad="true" OnRefreshData="Store1_Refresh">
        ...
        <Reader>
            <ext:JsonReader ReaderID="CustomControlId">
                <Fields>
                    <ext:RecordField Name="Name" />
                    <ext:RecordField Name="ClassName" />
                    <ext:RecordField Name="CustomControlId" />
                </Fields>
            </ext:JsonReader>
        </Reader>
    </ext:Store>
                ...
                <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" TrackMouseOver="false">
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column Header="CustomControlId" DataIndex="CustomControlId" Width="100" Hidden="true" Sortable="false">
                            </ext:Column>
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>

<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CrmPages_Admin_Plugin_PluginDllEditReflex" Codebehind="PluginDllEditReflex.aspx.cs" %>
...
<body>
    ...
    <div style="padding: 5px;">
            ...
            <rx:ColumnLayout runat="server" ID="ColoumnLayout1" ColumnWidth="100%">
                <Rows>
                    ...
                    <rx:RowLayout runat="server" ID="RowLayout8">
                        <Body>
                            <rx:FileUpload ID="FileUploadField1" runat="server" EmptyText="Dosya Seç" FieldLabel="Dil"
                                AutoWidth="true">
                            </rx:FileUpload>
                        </Body>
                    </rx:RowLayout>
        ...
        <table width="100%">
            <tr align="center">
                <td align="right">
                    <rx:Button ID="SaveButton" runat="server" Text="Save" Width="80">
                        <AjaxEvents>
